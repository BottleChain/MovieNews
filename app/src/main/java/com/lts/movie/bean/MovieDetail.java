...
public class MovieDetail {
     ...
     * popularity : 21.646757
     * poster_path : /2Sns5oMb356JNdBHgBETjIpRYy9.jpg
     * production_companies : [{"name":"United Artists","id":60},{"name":"Fantasy Films","id":286},{"name":"Warner Bros.","id":6194}]
    ...
    public String getGenresFormat() {
        ...
        for (GenresBean genresBean : getGenres()) {
            stringBuilder.append(genresBean.getName());
